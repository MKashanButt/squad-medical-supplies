...
export default function Footer() {
    return (
        <>
            ...
            <p className={styles.copyright}> Copyright Company &#169; Squad Medical Supplies. All Rights Reserved 2020 - {new Date().getFullYear()} & Content By Ahmed Ayat (Chief Medical Assistant)</p>
        </>
    )
}