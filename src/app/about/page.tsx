            ...
            <section className={styles.services}>
                ...
                <div className={styles.stage}>
                    <div className={styles.tabs}>
                        <div className={`${styles.item} ${styles.active}`} onClick={() => setActiveTabs('dme')}>
                        ...
                        <div className={`${styles.item}`} onClick={() => setActiveTabs('healthcare')}>
                            <svg width="40" height="40" viewBox="0 0 25 24" xmlns="http://www.w3.org/2000/svg" className={styles.icon}>
                        ...
                        <div className={`${styles.item}`} onClick={() => setActiveTabs('caregiver')}>
